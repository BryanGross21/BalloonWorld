...
namespace BalloonWorld.Rooms
{
	public class pqTestMap : GameScreen
	{
		...
		public override void Activate()
		{
			...
			player = new princess(new Vector2(250, (ScreenManager.GraphicsDevice.Viewport.Height + 500) / 2), ScreenManager.GraphicsDevice.Viewport.Height, ScreenManager.GraphicsDevice.Viewport.Width);
			...
			key = new Item(itemType.key,
				 new Vector2(500, 225));
			key.LoadContent(_content);
			items.Add(key);
			lantern = new Item(itemType.lantern, new Vector2(250, 250));
			lantern.LoadContent(_content);
			items.Add(lantern);
			keyDoor = new Door(new Vector2(1050, 200));
